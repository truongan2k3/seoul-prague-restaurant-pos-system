...
import { padReceiptLine, receiptItemEscPosLines, receiptItemsHeaderEscPosLine, receiptMetaEscPosLines, formatReceiptQtyTimesPrice, RECEIPT_LINE_WIDTH } from "@/lib/receipt-line-format";
...
export function buildReceiptEscPosLines(
  ...
  for (const item of data.items) {
    ...
    lines.push(...receiptItemEscPosLines(item.name, right, RECEIPT_LINE_WIDTH));
  }
