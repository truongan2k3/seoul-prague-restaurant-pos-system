    ...
    <div className="landing-theme min-h-screen bg-[#0B0B0C] text-white">
      ...
      <main className="pb-24 pt-28 lg:pb-16">
        <div className="mx-auto max-w-5xl px-5 lg:px-8">
          ...
          <h1 className="landing-serif mt-4 text-4xl lg:text-6xl">Full menu</h1>
          <p className="mt-4 max-w-2xl text-white/60">
            All items are managed in the website admin. Prices and availability can be updated anytime.
          </p>
                        ...
                        <div className="flex min-w-0 flex-1 gap-4">
                          ...
                          <div>
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              {item.badge ? (
                                <span className="text-[10px] uppercase tracking-wider text-[#C9A88B]">{item.badge}</span>
                              ) : null}
                            </div>
