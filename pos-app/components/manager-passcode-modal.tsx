  ...
  return (
    ...
    >
      <ModalPanel className="w-full max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow-2xl dark:border-gray-700 dark:bg-gray-800">
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">{translate("managerPasscodePrompt")}</p>
        <input
          type="password"
          value={passcode}
        ...
        />
        {pinError && (
          <p className="mt-2 text-sm text-red-600 dark:text-red-400">{translate("managerPasscodeInvalid")}</p>
        )}
