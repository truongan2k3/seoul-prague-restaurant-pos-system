    ...
    <>
      ...
      >
          ...
          <div className="flex shrink-0 items-center justify-between border-b border-gray-200 px-3 py-2 dark:border-gray-700 sm:px-5 sm:py-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg text-gray-400 hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-gray-800 dark:hover:text-gray-200 sm:h-11 sm:w-11 sm:rounded-xl"
              >
                <X className="h-6 w-6" />
              </button>
            </div>
        ...
        >
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col lg:max-w-[58%]">
            <div className="shrink-0 border-b border-gray-200 md:hidden dark:border-gray-700">
              <div className="flex gap-1.5 overflow-x-auto px-2 py-1.5 no-scrollbar sm:gap-2 sm:px-3 sm:py-2">
                <button
                  type="button"
                  onClick={() => setActiveCategory("__all__")}
                  className={`shrink-0 whitespace-nowrap rounded-full px-2.5 py-1 text-[11px] font-semibold sm:px-3 sm:py-1.5 sm:text-xs ${filterButtonClass(activeCategory === "__all__")}`}
                >
                  {translate("allCategories")}
                </button>
                {categoryOptions.map((category) => (
                  <button
                    ...
                    type="button"
                    onClick={() => setActiveCategory(category.id)}
                    className={`shrink-0 whitespace-nowrap rounded-full px-2.5 py-1 text-[11px] font-semibold sm:px-3 sm:py-1.5 sm:text-xs ${filterButtonClass(activeCategory === category.id)}`}
                  >
                    {category.name}
                  </button>
                ))}
            ...
            <main className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
              <div className="shrink-0 border-b border-gray-200 px-2 py-2 dark:border-gray-700 sm:px-4 sm:py-3">
                <div className="flex gap-2">
                  <div className="relative min-w-0 flex-1">
                    <Search className="pointer-events-none absolute left-2.5 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 sm:left-3 sm:h-5 sm:w-5" />
                    <input
                      type="search"
                      value={search}
                      ...
                      className="min-h-9 w-full rounded-lg border border-gray-200 bg-gray-50 py-1.5 pl-9 pr-3 text-sm outline-none focus:ring-2 focus:ring-gray-400 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 sm:min-h-[48px] sm:rounded-xl sm:py-3 sm:pl-11 sm:pr-4 sm:text-base"
                    />
                  </div>
                  <button
                    type="button"
                    ...
                    className="inline-flex min-h-9 shrink-0 items-center gap-1 rounded-lg border border-gray-200 bg-white px-2.5 text-xs font-semibold text-gray-800 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700 sm:min-h-[48px] sm:gap-1.5 sm:rounded-xl sm:px-3 sm:text-sm"
                  >
        ...
        <button
          ...
          className="pos-mobile-sticky-bar fixed bottom-0 left-0 right-0 z-30 flex min-h-11 items-center justify-between border-t border-gray-200 bg-gray-900 px-3 py-2 text-left text-white shadow-lg md:hidden dark:border-gray-700 dark:bg-gray-100 dark:text-gray-900 sm:min-h-[56px] sm:px-4 sm:py-3"
        >
